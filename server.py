...
if __name__ == "__main__":
    ...
    # threaded=True is important: without it, a single slow request (e.g. a
    # MongoDB connection attempt that's timing out) blocks EVERY other
    # request behind it, which looks exactly like "the whole site is stuck"
    # even though only one thing was actually slow.
    socketio.run(app, host="0.0.0.0", port=port, allow_unsafe_werkzeug=True, threaded=True)
